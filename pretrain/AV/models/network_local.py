...
class PGNet(nn.Module):
    def __init__(self, input_ch=3, resnet='convnext_tiny', num_classes=3, use_cuda=False, pretrained=False,centerness=False, centerness_map_size=[128,128],use_global_semantic=False):
        ...
        cut = 6
        if pretrained:
            layers = list(base_model(weights=r'./convnext_tiny-983f1562.pth').features)[:cut]
        else:
