...
class LogMaker():
    def __init__(self, opt, config_file):
        ...
        shutil.copy('./Tools/AVclassifiationMetrics.py', os.path.join(self.log_folder, 'AVclassifiationMetrics.py'))
        shutil.copy('./Tools/data_augmentation.py', os.path.join(self.log_folder, 'data_augmentation.py'))
        shutil.copy('./main.py', os.path.join(self.log_folder, 'main.py'))
